...
export class Compiler {
	...
	public nilnoviProgramIndex: number = 0;
	public nbLine: number = 0;
	...
	//  * @author Adam RIVIÈRE
	//  */
	// private createProcedureFunction() {
	...
	//  * @author Adam RIVIÈRE
	//  */
	// private isVar(expression: string) {
	// 	for (let i = 0; i < this.varTable.length; i++) {
	// 		if (this.varTable[i].name == expression) { return true; }
	// 	}
	// 	return false;
	// }
	...
	// 	for (let i = 0; i < this.varTable.length; i++) {
	// 		if (this.varTable[i].name == variableName) { return this.varTable[i]; }
	// 	}
	...
	//  * @author Adam RIVIÈRE
	//  */
	// private generateParams(expression: string, isParam: boolean) {
	// 	var params: Variable[] = [];
	// 	var isValue = true;
	// 	var isType = false;
	// 	var currentType = "";
	...
	// 					var name = nameList[i];
	// 					if (!this.isValidName(name)) { console.error("Not valid name"); }
	// 					currentType.trim();
	// 					if (!this.isValidType(currentType)) { console.error("not valid type"); }
	...
	// 		else {
	// 			if (isValue) { currentName += char; }
	// 			else if (isType) { currentType += char; }
	// 		}
	// 	}
